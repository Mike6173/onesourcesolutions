...
import ContactFormLight from "@/components/ui/light/ContactFormLight";
import { BUSINESS, LOCATIONS } from "@/lib/constants";
import Link from "next/link";

export const metadata: Metadata = {
  title: "Contact Us (Light Theme), Get a Free Estimate",
  description:
...
export default function ContactLightPage() {
  return (
    <div className="bg-white">
      {/* Hero */}
      <section className="pt-32 pb-12 bg-white relative overflow-hidden">
        <div className="absolute top-1/2 right-0 w-[500px] h-[400px] bg-blue-50 rounded-full blur-3xl" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href={BUSINESS.phoneHref} className="text-gray-600 hover:text-gray-900 transition-colors duration-150 text-sm">
                        {BUSINESS.phone}
                      </a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href={BUSINESS.emailHref} className="text-gray-600 hover:text-gray-900 transition-colors duration-150 text-sm break-all">
                        {BUSINESS.email}
                      </a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Long Island, New York<br />Nassau & Suffolk Counties</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Monday – Friday: 8am – 6pm<br />Saturday: 9am – 4pm<br />Sunday: By appointment</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                <div className="text-sm text-gray-500 mb-1">Your direct contact</div>
                <div className="text-gray-900 font-semibold text-lg mb-3">{BUSINESS.contact}</div>
                <div className="space-y-2">
                  <a href={BUSINESS.phoneHref} className="flex items-center gap-2 text-blue-800 hover:text-blue-900 text-sm transition-colors duration-150">
                    <Phone className="w-4 h-4" /> {BUSINESS.phone}
                  </a>
                  <a href={BUSINESS.emailHref} className="flex items-center gap-2 text-blue-800 hover:text-blue-900 text-sm transition-colors duration-150 break-all">
                ...
                <div className="flex flex-wrap gap-2">
                  {LOCATIONS.map((loc) => (
                    <Link
                      ...
                      className="text-xs text-gray-600 bg-white border border-gray-200 rounded-full px-3 py-1.5 hover:text-gray-900 hover:border-blue-400 transition-colors duration-150"
                    >
                      {loc.name}
                    </Link>
                  ))}
                  <span className="text-xs text-gray-500 bg-white border border-gray-200 rounded-full px-3 py-1.5">
                    + More
                  </span>
                </div>
              </div>
            ...
            <div className="lg:col-span-3">
              <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
                ...
                <p className="text-gray-500 text-sm mb-7">All fields marked with * are required.</p>
                <ContactFormLight />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            {[
              ...
              <div key={i} className="flex flex-col items-center">
                <CheckCircle className="w-6 h-6 text-blue-800 mb-2" />
