...
const reasons = [
  ...
  {
    icon: <ThumbsUp className="w-6 h-6 text-blue-800" />,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {reasons.map((reason, i) => (
            <div
              key={i}
              className="bg-white border border-gray-200 rounded-2xl p-6 hover:border-blue-400 hover:shadow-lg hover:shadow-blue-800/5 transition-all duration-200 group"
            >
