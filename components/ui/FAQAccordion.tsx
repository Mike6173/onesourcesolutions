      ...
      {items.map((item, i) => (
        <div
          ...
          className={clsx(
            ...
            openIndex === i
              ? "border-electric/40 bg-navy-light"
              : "border-navy-border bg-navy-card hover:border-navy-border/80"
          )}
        >
          <button
          ...
          >
            ...
            <ChevronDown
              className={clsx(
                "w-5 h-5 flex-shrink-0 text-electric transition-transform duration-200",
